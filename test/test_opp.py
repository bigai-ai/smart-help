...
from model.classifier_dep import Classifier_OppenentModeling_v2
        ...
        for type_index in range(0, 1):
            ...
            for env_index in range(0, 10):
                ...
                while not done:
                    ...
                    if torch.cuda.is_available():
                        input_matrix = torch.from_numpy(data).cuda().float()


                    subtask_predict, tar_index_1_predict, tar_index_2_predict, type_predict = classifier(input_matrix)
                    ...
                    predicted_subtask = [subtask_predict, tar_index_1_predict, tar_index_2_predict]
